# Contributing
Feel free to contribute to the development of the Cycle ORM Entity Behavior UUID.
...
## Testing Cycle ORM Entity Behavior Identifier
To test Cycle ORM Entity Behavior Identifier locally, download the `cycle/entity-behavior-identifier` repository and start docker containers inside the tests folder:
...
## Official Support
Cycle ORM Entity Behavior UUID are maintained by [Spiral Scout](https://spiralscout.com/).

For commercial support please contact team@spiralscout.com.

## Licensing
Cycle ORM Entity Behavior UUID will remain under [MIT license](/LICENSE) indefinitely.
